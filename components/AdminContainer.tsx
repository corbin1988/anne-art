      ...
      <div className="fixed flex flex-col w-14 hover:w-64 md:w-64  bg-white h-full text-gray-800 transition-all duration-300 border-none z-10 sidebar">
        <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul className="flex flex-col py-4 space-y-1">
            ...
            <li>
              <Link href="/admin" className="relative flex flex-row items-center h-11 focus:outline-none hover: dark:hover:bg-gray-200 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                ...
                <span className="ml-2 text-sm tracking-wide truncate">Art</span>
              </Link>
            </li>
            <li>
